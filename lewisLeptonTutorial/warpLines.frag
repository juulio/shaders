...
void main(){
    ...
    color += sin(coord.x * 20.0 + cos(u_time + coord.y * 10.0 + sin (coord.x * 50.0 + u_time * 2.0))) * 2.0;
    color += sin(coord.x * 10.0 + cos(u_time + coord.y * 10.0 + sin (coord.x * 50.0 + u_time * 2.0))) * 2.0;
